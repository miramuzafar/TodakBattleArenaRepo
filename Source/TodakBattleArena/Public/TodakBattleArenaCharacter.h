...
protected:
	...
	UFUNCTION(BlueprintCallable)
		void IncreaseMaxAttributes(float StrengthIncrement, float StaminaIncrement, float AgilityIncrement, float StaminaPercent, float StrengthPercent, float AgilityPercent);
